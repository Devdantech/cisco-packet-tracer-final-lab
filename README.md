...
<p align="center">
  <img src="images/01-dns-records.png" alt="DNS A records for breadcrumb domains" width="80%">
...
<p align="center">
  <img src="images/02-web-server-files.png" alt="Web server HTTP/HTTPS and HTML files" width="80%">
...
<p align="center">
  <img src="images/03-switch-cli.png" alt="Switch basic config" width="80%">
  <br><strong>Hostname, passwords, VLAN 1 IP 192.168.10.2/24, write memory</strong>
</p>

### 4. DHCP Server Pool Settings
<p align="center">
  <img src="images/04-dhcp-pool.png" alt="DHCP pool configuration" width="80%">
